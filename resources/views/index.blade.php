...
<section class="section">
    <div class="container">
        <nav class="top-right-nav">
            <aside>
                <h1 align="right"><a href="dashboard.blade.php" title="Dashboard" id="dashboard-link">Dashboard</a></h1>
                <h1 align="right"><a href="profile.blade.php" title="My profile" id="profile-link">Profile</a></h1>
                <h1 align="right"><a href="faq.blade.php" title="FAQ" id="faq-link">FAQ</a></h1>
                <h1 align="right"><a href="blog/blogindex.blade.php" title="Blog" id="blog-link">Blog</a></h1>
            </aside>
        </nav>
        ...
        <h2 id="longfont">
            <ul>
                <li>
                    <p><u class="underline-small">I enjoy problem solving,
        ...
        <h1 align="left"><span id="basestyle"></span><b>Some snippets of the aforementioned codes:</b></h1>
        <h2 id="longfont">
            <br>
            <p><u class="underline-small">Another reason is that when I have an idea I try
                    and
                    code it
