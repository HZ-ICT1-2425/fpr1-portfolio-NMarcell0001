...
@section('content')
    <div class="container">
        ...
        <h2 id="longfont">
            ...
            <p><i>I dislike repeating my own words over and over and over and over again. (This is another
                    paragraph)</i>
            </p>
                ...
                <ul>
                    ...
                    <li>
                        <img src="pictures/github-invertocat-logo.png" width="50px" ; height="50px" ;> <a
                            href="https://github.com/NMarcell0001" title="Github profile"
                            target="_blank">NMarcell0001</a>
                    </li>
                </ul>
            </table>
        </h2>
